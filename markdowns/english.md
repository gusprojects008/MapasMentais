...
| were  | passado simples         | You, We, They         | We were late           | Nos estavamos atrasados (were == eram/estavam)                           |
| be    | Forma base / infinitivo | Usado com auxiliares  | I want to be a teacher | Eu quero ser um professor (be == ser/estar/existir)                      |
| been  | Particípio passado      | com have/has/had      | She has been sick      | Ela tem estado doente (been == foram/sido/estado, has == Tem/Possui/Foi) |
| being | Gerúndio                | ação contínua/passiva | He is being nice today | Ele está sendo legal hoje (being == sendo/começando/iniciando)           |
